...
public class CommonConstant {
    ...
    public static final String MAJAR_SERVER_HOST = "http://localhost:8085";
    ...
    public static final String RESOURCCE_TYPE_STATISTIC_PERFORMANCE = "statistic_performance";
...
/*    Checkout - The checkout has not been completed.
    ...
    public static final String EVENT_COMPANY_CREATE = "EVENT_COMPANY_CREATE";


    public static final String EVENT_ROUTE_CREATE = "EVENT_ROUTE_CREATE";
    ...
    public static final String QRCODE_SCAN_weixin_temporary = "QRCODE_SCAN_weixin_temporary";
    public static final String QRCODE_SCAN_weixin_permanent = "QRCODE_SCAN_weixin_permanent";
